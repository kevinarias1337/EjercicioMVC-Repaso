...
namespace MODELO
{
    public class ClsDatos
    {
        ...
        #region Constructor Cadena Conexíon
        public ClsDatos() //Constructor
        {
            this.strCadenaConexion = @"Data Source=SALA403-7\SQLEXPRESS;Initial Catalog=bdolimpiadas;Integrated Security=True";
        }
        #endregion
